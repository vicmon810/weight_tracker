...
nohup uvicorn health_api:app --host 0.0.0.0 --port 8999 --reload > back.log 2>&1 &
...
nohup streamlit run dashboard.py --server.port 8501 --server.address 0.0.0.0 > front.log 2>&1 &